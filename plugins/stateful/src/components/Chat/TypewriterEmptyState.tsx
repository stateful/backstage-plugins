...
const TypewriterEmptyState = () => {
  ...
  const message ="Hi! I'm here to help. Describe your task below, then press <Enter>."
  ...
  return (<Box className={classes.emptyState}>
      <CloudIcon style={{ marginRight: 10}}/> {text} {!isDone && <BlinkWrapper> |</BlinkWrapper>}
  </Box>)
}
